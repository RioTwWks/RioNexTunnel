...
[← Documentation index](README.md) · [Русский](../ru/linux_setup.md)
...
2. Load unpacked extension: `extensions/secure-vpn-proxy-auth/` — see [browser-extension.md](browser-extension.md).

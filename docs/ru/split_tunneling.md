...
## Linux TUN (режим VPN на десктопе)

**Статус:** полный туннель доступен в **Режим работы → VPN** на Linux/Windows/macOS — см. [desktop_vpn.md](desktop_vpn.md). Per-app split tunnel на desktop TUN **пока не реализован**.

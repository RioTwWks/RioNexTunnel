...
## Linux TUN (в перспективе)

При появлении TUN на Linux потребуются **policy routing / cgroups** и защита от обхода через неаутентифицированный localhost. Сейчас десктоп работает в proxy mode.
